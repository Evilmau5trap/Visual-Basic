    ...
    Dim gstrQuestions As String(,) = { _
        {"English Springer Spainel", "Akita", "Husky", "Bearded Collie", "dog051.jpg"}, _
    ...
    Private Sub DisplayQuestion(ByVal shrQuestion As Short)
        ...
        'Check if user clicked previous button qith question 1 displayed
        ...
        'Store user's answer to previous in gshrAnswers array
        Select Case True
        ...
        If shrQuestion > gstrQuestions.GetUpperBound(0) Then
            If MessageBox.Show("You have answer the last question. Would you like to display the final quiz result and exit the quiz?" _
    ...
    Private Sub mnuPrevious_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuPrevious.Click
        DisplayQuestion(gshrCurrentQuestion - Convert.ToInt16(1)) 'Display the previous question
    End Sub
