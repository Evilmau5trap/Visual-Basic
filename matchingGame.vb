'Boolean variables are stored as 16-bit (2-byte) numbers, but they can only be True or False.
    ...
    Private Function checkForMatch()
        Dim one, two As Byte
        If firstPick = 1 Or firstPick = 7 Then
            one = 1
        End If
        If secondPick = 1 Or secondPick = 7 Then
            two = 1
        End If
        If firstPick = 2 Or firstPick = 8 Then
            one = 2
        End If
        If secondPick = 2 Or secondPick = 8 Then
            two = 2
        End If
        If firstPick = 3 Or firstPick = 9 Then
            one = 4
        End If
        If secondPick = 3 Or secondPick = 9 Then
            two = 4
        End If
        If firstPick = 4 Or firstPick = 10 Then
            one = 6
        End If
        If secondPick = 4 Or secondPick = 10 Then
            two = 6
        End If
        If firstPick = 5 Or firstPick = 11 Then
            one = 3
        End If
        If secondPick = 5 Or secondPick = 11 Then
            two = 3
        End If
        If firstPick = 6 Or firstPick = 12 Then
            one = 5
        End If
        If secondPick = 6 Or secondPick = 12 Then
            two = 5
        End If
        If one = two Then
            firstPick = 0
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'On form load, declare all the variable values
        initialize()
    End Sub
    ...
    Private Sub pic1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic1.Click
        pic1.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\Crab.jpg")
    ...
    Private Sub pic2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic2.Click
        pic2.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\DonaldDuck.jpg")
        Select Case currentPlayer
            Case 1
                If currentPair = True Then
                    secondPick = 2
    ...
    Private Sub pic3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic3.Click
        pic3.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\Edd.jpg")
        Select Case currentPlayer
            Case 1
                If currentPair = True Then
                    secondPick = 3
    ...
    Private Sub pic4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic4.Click
        pic4.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\HankHill.jpg")
        Select Case currentPlayer
            Case 1
                If currentPair = True Then
                    secondPick = 4
    ...
    Private Sub pic5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic5.Click
        pic5.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\LittleThing.jpg")
        Select Case currentPlayer
            Case 1
                If currentPair = True Then
                    secondPick = 5
    ...
    Private Sub pic6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic6.Click
        pic6.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\TweetyBird.jpg")
        Select Case currentPlayer
            Case 1
                If currentPair = True Then
                    secondPick = 6
    ...
    Private Sub pic7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic7.Click
        pic7.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\Crab.jpg")
        Select Case currentPlayer
            Case 1
                If currentPair = True Then
                    secondPick = 7
    ...
    Private Sub pic8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic8.Click
        pic8.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\DonaldDuck.jpg")
        Select Case currentPlayer
            Case 1
                If currentPair = True Then
                    secondPick = 8
    ...
    Private Sub pic9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic9.Click
        pic9.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\Edd.jpg")
        Select Case currentPlayer
            Case 1
                If currentPair = True Then
                    secondPick = 9
    ...
    Private Sub pic10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic10.Click
        pic10.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\HankHill.jpg")
        Select Case currentPlayer
            Case 1
                If currentPair = True Then
                    secondPick = 10
    ...
    Private Sub pic11_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic11.Click
        pic11.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\LittleThing.jpg")
        Select Case currentPlayer
            Case 1
                If currentPair = True Then
                    secondPick = 11
    ...
    Private Sub pic12_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pic12.Click
        pic12.Image = Image.FromFile("C:\Users\stu316130\Pictures\MatchingGame\TweetyBird.jpg")
        Select Case currentPlayer
            Case 1
                If currentPair = True Then
                    secondPick = 12
